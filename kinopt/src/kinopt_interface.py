...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dockWidgetData_extraction.setMinimumSize(QSize(356, 281))
        ...
        self.page_models_and_parameters.setGeometry(QRect(0, 0, 214, 747))
        ...
        self.scrollAreaWidgetContents_models_and_parameters.setGeometry(QRect(0, 0, 194, 680))
        ...
        self.page_optimization_methods_and_parameters.setGeometry(QRect(0, 0, 214, 747))
        ...
        self.scrollAreaWidgetContents_optimization_methods.setGeometry(QRect(0, 0, 194, 680))
